...
*/
FOUNDATION_EXPORT NSString *const APLAnonymousUser;


@interface APLSettings : NSObject <NSCoding>
...
/**
* Enable it when you use Applause with your uTest application. It is enabled by default.
*/
